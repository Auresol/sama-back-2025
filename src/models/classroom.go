...
type Classroom struct {
	SchoolID  uint   `json:"school_id,omitempty" gorm:"primarykey;autoIncrement:false"`
	Classroom string `json:"classroom,omitempty" gorm:"primarykey;autoIncrement:false"`
